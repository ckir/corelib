 ...
 * @template T - The expected response body type.
 */
export declare function endPoint<T = unknown>(url: string | URL | Request, options?: KyOptions): Promise<RequestResult<T>>;
/**
 ...
 */
export declare function endPoints<T = unknown>(urls: (string | URL | Request)[], options?: KyOptions): Promise<RequestResult<T>[]>;
/**
