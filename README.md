...
You can point your package manager directly to the `.tgz` file in the GitHub Release. Replace `v0.1.15` with the desired version.

```bash
# Using pnpm
pnpm add https://github.com/ckir/corelib/releases/download/v0.1.15/ckir-corelib-0.1.15.tgz
pnpm add https://github.com/ckir/corelib/releases/download/v0.1.15/ckir-corelib-markets-0.1.15.tgz

# Using npm
npm install https://github.com/ckir/corelib/releases/download/v0.1.15/ckir-corelib-0.1.15.tgz
```
...
"pnpm": {
  "overrides": {
    "@ckir/corelib": "https://github.com/ckir/corelib/releases/download/v0.1.15/ckir-corelib-0.1.15.tgz"
  }
}
```
